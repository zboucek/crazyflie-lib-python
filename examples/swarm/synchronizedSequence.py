...
uris = [
    'radio://0/100/2M/E7E7E7E701',  # cf_id 0, startup position [-0.5, -0.5]
...
sequence = [
    ...
    (12,    0,      Ring(255, 255, 255, 0.2, 0)),
    (12,    1,      Ring(255, 0, 0, 0.2, 0)),
    (12,    2,      Ring(255, 255, 255, 0.2, 0)),

    (14,    0,      Goto(0.5, -0.5, 0.5, 2)),
    (14,    2,      Goto(-0.5, 0.5, 0.5, 2)),

    (16,    0,      Goto(0.5, 0.5, 0.5, 2)),
    (16,    2,      Goto(-0.5, -0.5, 0.5, 2)),

    (18,    0,      Goto(-0.5, 0.5, 0.5, 2)),
    (18,    2,      Goto(0.5, -0.5, 0.5, 2)),

    (20,   0,      Goto(-0.5, -0.5, 0.5, 2)),
    (20,   2,      Goto(0.5, 0.5, 0.5, 2)),
